...
//Not supposed to use Interrupt, we're supposed to use polling, which is just constantly checking the receive until it returns 0
...
//Implemented usart_getc() in the uart.c to do polling instead of interrupt
